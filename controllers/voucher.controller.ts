...
const getAllVouchers: RequestHandler<
	{},
	{ message: string; page?: number; perPage?: number; data?: Voucher[]; error?: unknown },
	{ payload: Payload },
	{ page?: number; perPage?: number }
> = async (req, res) => {
...
const createVoucher: RequestHandler<
	{},
	{ message: string; data?: Voucher; error?: unknown },
	{ payload: Payload; data: Prisma.VoucherCreateInput & { business_id: string } },
	{ page?: number; perPage?: number }
> = async (req, res) => {
	try {
